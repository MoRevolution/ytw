...
function getMarathonComparison(hours: number): string {
  ...
  if (hours >= 6)
    return "You could've watched the entire Lord of the Rings trilogy!";
          ...
          <div className="container py-6 md:py-12">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">
                {stats
                  ? `Here's a summary of your YouTube activity from ${stats.primaryYear.year}${stats.comparisonYear ? ` compared to ${stats.comparisonYear.year}` : ""}.`
            ...
            {isLoading ? (
              ...
              <>
                    ...
                    <Card className="card-hover card-hero">
                      ...
                      <CardContent>
                        <div className="text-4xl font-bold">
                          <AnimatedStat
                            value={stats?.primaryYear.watchTime || 0}
                            decimals={1}
                          />
                        </div>
                        ...
                        {stats?.comparisonYear && (
                          <div className="mt-4 flex items-center gap-2">
                            <div className="text-sm text-muted-foreground">
                              <span
                                className={
                                  stats.primaryYear.watchTime >
                                  stats.comparisonYear.watchTime
                                    ? "text-green-500"
                                    : "text-red-500"
                                }
                              >
                  ...
                  <AnimatedCard delay={100}>
                    <Card className="card-hover card-hero">
                      ...
                      <CardContent>
                        <div className="text-4xl font-bold">
                          <AnimatedStat
                            value={stats.primaryYear.videosWatched}
                            delay={100}
                          />
                        </div>
                        ...
                        {stats.comparisonYear && (
                          <div className="mt-4 flex items-center gap-2">
                            <div className="text-sm text-muted-foreground">
                              <span
                                className={
                                  stats.primaryYear.videosWatched >
                                  stats.comparisonYear.videosWatched
                                    ? "text-green-500"
                                    : "text-red-500"
                                }
                              >
                  ...
                  <AnimatedCard delay={200}>
                    <Card className="card-hover card-hero">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>
                          Different channels you watched
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="text-4xl font-bold">
                          <AnimatedStat
                            value={stats.primaryYear.uniqueCreators}
                            delay={200}
                          />
                        </div>
                        ...
                        {stats.comparisonYear && (
                          <div className="mt-4 flex items-center gap-2">
                            <div className="text-sm text-muted-foreground">
                              <span
                                className={
                                  stats.primaryYear.uniqueCreators >
                                  stats.comparisonYear.uniqueCreators
                                    ? "text-green-500"
                                    : "text-red-500"
                                }
                              >
                      ...
                      <Card className="w-full overflow-hidden">
                        ...
                        <CardContent className="px-6 pb-2">
                          <div className="flex gap-4 overflow-x-auto pb-3 scroll-container">
                            {stats?.primaryYear.mostWatchedVideos?.map(
                              (video, index) => (
                                <a
                                  key={video.videoId}
                          ...
                          >
                            <div className="space-y-3">
                              {stats?.primaryYear?.categoryStats
                                ?.slice(0, 5)
                                .map(
                                  (category: CategoryStats, index: number) => {
                                    const colors =
                                      CATEGORY_COLORS[
                                        ...
                                        <div className="flex-1 min-w-0">
                                          <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-sm text-muted-foreground ml-2">
                                              {category.watchTime.toFixed(1)}h
                                            </span>
                                          </div>
                          ...
                          >
                            <div className="flex items-center justify-between mb-3">
                              ...
                              >
                                ...
                                <span>
                                  {showNormalized ? "Normalized" : "Raw hours"}
                                </span>
                              </button>
                              <div className="group relative">
                                ...
                                <div className="absolute right-0 top-6 w-48 p-2 bg-popover border rounded-md shadow-lg text-xs opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                                  <strong>Raw:</strong> Total watch time
                                  <br />
                                  <strong>Normalized:</strong> Adjusts for video
                                  length so creators with shorter videos aren't
                                  penalized
                                </div>
                              </div>
                            </div>
                            <div className="space-y-3 flex-1">
                              {(() => {
                                ...
                                const maxValue = showNormalized
                                  ? Math.max(
                                      ...sortedCreators.map(
                                        (c) => c.normalizedScore || 0,
                                      ),
                                    )
                                  : Math.max(
                                      ...sortedCreators.map((c) => c.watchTime),
                                    );
                  ...
                  <AnimatedCard delay={500}>
                    <Card className="card-hover h-full min-h-[380px] relative overflow-hidden flex flex-col">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="group relative z-10">
                            ...
                            <div className="absolute right-0 top-6 w-52 p-2 bg-popover border rounded-md shadow-lg text-xs opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                              A session is defined as consecutive videos watched
                              within 30 minutes of each other. We find your
                              longest uninterrupted viewing streak!
                            </div>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 flex flex-col justify-center">
                          <div>
                            <p className="text-4xl font-bold text-orange-500">
                              {stats?.primaryYear?.longestSession?.duration?.toFixed(
                                1,
                              ) || "0"}
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                              {getMarathonComparison(
                                stats?.primaryYear?.longestSession?.duration ||
                                  0,
                              )}
                            </p>
                          </div>
                        ...
                        {stats?.primaryYear?.longestSession?.videos &&
                          stats.primaryYear.longestSession.videos.length >
                            0 && (
                                ...
                                data={{
                                  ...
                                  datasets: [
                                    ...
                                    },
                                    {
                                      ...
                                      data:
                                        stats?.primaryYear.monthlyWatchTime ||
                                        Array(12).fill(0),
                                      backgroundColor:
                                        "rgba(59, 130, 246, 0.7)",
                                ...
                                data={{
                                  ...
                                  datasets: [
                                    ...
                                    },
                                    {
                                      ...
                                      data:
                                        stats?.primaryYear.monthlyVideoCounts ||
                                        Array(12).fill(0),
                                      backgroundColor:
                                        "rgba(16, 185, 129, 0.7)",
                ...
                {stats?.primaryYear?.tags &&
                  stats.primaryYear.tags.length > 0 && (
                      ...
                      <div className="mt-8">
                        <Card>
                          <CardHeader>
                            ...
                            <CardDescription>
                              Most common tags from your watched videos
                            </CardDescription>
                          </CardHeader>
                          <CardContent>
                            <WordCloudComponent tags={stats.primaryYear.tags} />
                          </CardContent>
                        </Card>
                      </div>
                    </AnimatedCard>
                ...
                <AnimatedCard delay={800}>
                  <div className="mt-12 text-center">
                    <ShareStats
                      stats={{
                        watchTime: parseFloat(
                          (stats?.primaryYear.watchTime || 0).toFixed(1),
                        ),
                        videosWatched: stats?.primaryYear.videosWatched || 0,
                        topCategory:
                          stats?.primaryYear.topCategory || "Unknown",
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      Generate a shareable image to post on social media
                    </p>
                  </div>
                </AnimatedCard>
              </>
